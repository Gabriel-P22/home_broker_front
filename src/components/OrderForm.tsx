...
export function OrderForm(props: { asset: Asset, wallet_id: string, type: OrderType}) {
    ...
    async function onSubmit (event: FormEvent<HTMLFormElement>) {
        ...
        const newOrders: Order = await socket.emitWithAck('orders/create', data);
        toast(`Ordem de ${translatedType} de ${newOrders.shares} ações de ${props.asset.symbol} criada com sucesso`,
